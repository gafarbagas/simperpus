...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-dark">Ubah Buku</h1>
</div>

<div class="card shadow mb-4">
    <div class="card-body">
        <form action="{{ route('admin.book.update', Crypt::encrypt($book->id)) }}" method="POST">
            @csrf
            @method('PATCH')
            <div class="row">
                <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('edition') is-invalid @enderror" id="edition" name="edition" value="{{ old('edition', $book->edition) }}">
                        @error('edition')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('volume') is-invalid @enderror" id="volume" name="volume" value="{{ old('volume', $book->volume) }}">
                        @error('volume')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('printed') is-invalid @enderror" id="printed" name="printed" value="{{ old('printed', $book->printed) }}">
                        @error('printed')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('place_of_publication') is-invalid @enderror" id="place_of_publication" name="place_of_publication" value="{{ old('place_of_publication', $book->place_of_publication) }}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('year_of_publication') is-invalid @enderror" id="year_of_publication" name="year_of_publication" value="{{ old('year_of_publication', $book->year_of_publication) }}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control @error('note') is-invalid @enderror" id="note" name="note">{{ old('note', $book->note) }}</textarea>
                        @error('note')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
